        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
             ...
             float4 frag(VertexOutput i) : COLOR {
                ...
                float node_3273 = 0.5;
                float node_5231 = saturate((1.0 - length(abs(((i.uv0-node_3273)/node_3273)))));
                float node_9521_ang = ((frac((node_6404.g*_Speed))*3.141592654)+(node_5231*_Spin));
                float node_9521_spd = 1.0;
                float node_9521_cos = cos(node_9521_spd*node_9521_ang);
                float node_9521_sin = sin(node_9521_spd*node_9521_ang);
                float2 node_9521_piv = float2(0.5,0.5);
                float2 node_9521 = (mul(i.uv0-node_9521_piv,float2x2( node_9521_cos, -node_9521_sin, node_9521_sin, node_9521_cos))+node_9521_piv);
                float node_1956 = 0.5;
                float2 node_7679 = abs(((node_9521-node_1956)/node_1956)).rg;
                ...
                float node_2935_spd = 1.0;
                float node_2935_cos = cos(node_2935_spd*node_2935_ang);
                float node_2935_sin = sin(node_2935_spd*node_2935_ang);
